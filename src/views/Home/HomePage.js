 ...
 * @LastEditTime: 2019-11-18 19:06:24
 */
import React, { Component } from 'react'
import './HomePage.less'
import { login } from 'apis'
import { LazyImage } from '../../components/_LazyImage/LazyImage'
import ThemeCard from '../../components/_ThemeCard/ThemeCard'
...
export default class HomePage extends Component {
    ...
    render() {
        return (
            <div className='Home_container' style={{ height: '100%', overflow: 'scroll' }} onScroll={this.onScroll.bind(this)}>
                {/* <h1>测试lazyImage,不在视口内图片不显示，在视口内才显示</h1>
